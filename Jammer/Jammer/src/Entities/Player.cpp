...
namespace jam {
	...
	void Player::update() {
		...
		*/
		...
		if (jam::InputManager::isKeyReleased(jam::KeyCodes::KEY_X)) move(sf::Vector2f( 0.0f, -200.0f)*jam::JamCore::deltaTime);

		move(sf::Vector2f(0.0f, 30.0f)*jam::JamCore::deltaTime);
