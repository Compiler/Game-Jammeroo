...
RayHit getMarchDistance(vec3 point){
    ...
    spheres[i].position = vec3(2. * cos(1.123), 3., 11.); spheres[i++].radius = 1.;
    spheres[i].position = vec3(2. * -cos(1.123), 3., 11.); spheres[i++].radius = 1.;
    spheres[i].position = vec3(7., 1.25 + 2.*(sin(1.123*1.5)), 10.); spheres[i++].radius = 1.;
    ...
    rayHits[4].dist = sdCapsule(point, vec3(-20., 5. * abs(sin(1.123 * 3.)) + 1., 30.), vec3(-15., 5. * abs(cos(1.123 * 3.)) + 1., 35.), 1.);
    rayHits[4].color =  vec3(1., 0., 1.);
    vec3 moving = vec3(0., 0.5, 3.);
    vec3 moving2 = vec3(0., 0.5, 3.);
    moving.xz += vec2(sin(1.123), cos(1.123));
    moving2.xz -= vec2(sin(1.123), cos(1.123));
...
float getLight(vec3 point){
    vec3 lightPosition = vec3(0, 4, -3);lightPosition.xz += vec2(sin(1.123), cos(1.123));
...
vec3 phongIllumination(vec3 k_a, vec3 k_d, vec3 k_s, float alpha, vec3 p, vec3 eye) {
    ...
    vec3 light1Pos = vec3(4.0 * sin(1.123),
                          2.0,
                          4.0 * cos(1.123));
    ...
    vec3 light2Pos = vec3(2.0 * sin(0.37 * 1.123),
                          2.0 * cos(0.37 * 1.123),
                          9.0);
